                ...
                {/*//Not Logged in*/}
                {
                    (uid === ""  || uid.length === 0) &&
                        ...
                        <div className="row justify-content-center">
                            <p className=" mr-2 lead">Copyright 2020 CodeSaver Technologies LLC. All rights reserved.
                                Privacy policies can be found <Link className="lead" to="/privacy">here</Link></p>
                        </div>
                        <div className="row justify-content-center">
